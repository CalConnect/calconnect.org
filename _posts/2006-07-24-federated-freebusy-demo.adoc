...
• can be implemented today.“Our members identified the need for a simple mechanism to see when a
...
http://www.opengroup.org/messaging/public/jul-2006/freebusydemo.pdf*The Calendaring and Scheduling Consortium (www.calconnect.org)* +
