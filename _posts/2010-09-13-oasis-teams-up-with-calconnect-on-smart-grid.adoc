...
excerpt: |
  CalConnect and OASIS have been tasked jointly by the National Institute for
  Standards and Technology (NIST) to produce one of the standards that will make
  it possible to monitor, predict and manage power consumption, known
  as WS-Calendar.
---
:page-liquid:
...
CalConnect and
OASIS have been tasked jointly by the National Institute
...
http://www.oasis-open.org/news/oasis-news-2010-09-13.php.
...
http://www.calconnect.org/tc-xml
