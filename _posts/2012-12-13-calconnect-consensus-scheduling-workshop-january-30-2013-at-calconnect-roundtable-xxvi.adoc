...
Please see link:{{'/resources/consensus-scheduling' | relative_url}}[Consensus Scheduling] a further introduction to consensus scheduling and why it matters to calendaring and scheduling.
