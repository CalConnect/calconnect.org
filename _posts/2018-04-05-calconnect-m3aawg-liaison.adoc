---
layout: page
title: Taking on Calendar Spam, Scheduling Developers Organization CalConnect Collaborates with Messaging Anti-Abuse M3AAWG
type: news
date: 2018-04-05
...
*News Release - Jointly issued by CalConnect and M3AAWG*
...
mailto:dave.thewlis@calconnect.org[dave.thewlis@calconnect.org]or CalConnect Director of
