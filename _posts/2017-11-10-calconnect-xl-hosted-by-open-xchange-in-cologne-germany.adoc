...
I hope to see you in link:{{'/events/calconnect-xli-winter-2018' | relative_url }}[Sunnyvale Califorania] Janjary 29 to February 2, where https://www.oath.com/[OATH] will host us. While you are at it: mark your calendar 4-8 June 2018 when http://www.jorte.com/[Jorte] will host us in Tokyo.
