...
link:{{"/events/calconnect-xxxviii-february-13-17-2017/" | relative_url}}[]

link:{{"/events/event-registration-payment/" | relative_url}}[]

The agenda and sessions for the Conference and Test Event / Developers  Forum are posted on the web page:

link:{{"/events/calconnect-xxxviii-february-13-17-2017#test-schedule/" | relative_url}}[]

link:{{"/events/calconnect-xxxviii-february-13-17-2017#conference-schedule/" | relative_url}}[]
...
As always, non-members may attend a CalConnect Conference as link:{{'/events/observers' | relative_url }}[Observers].
