...
The presentation is available at link:{{'/docs/presentations/Kepler%20Mission%20Operations%20Scheduling.pdf' | relative_url}}[Kepler Mission Operations Scheduling].
