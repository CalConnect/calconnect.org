...
For additional background on travel itineraries and calendaring and scheduling see "`7 Things about Digital Travel Itineraries`" at link:{{'/resources/7-things-you-should-know-about/itineraries' | relative_url}}[].

To learn more about becoming a member of CalConnect, see link:{{'/membership/why-join' | relative_url}}[why join].
