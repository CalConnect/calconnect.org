...
The CalConnect TASKS technical committee has just published a new briefing document, link:{{'/resources/tasks' | relative_url}}[7 Things You Should Know About Tasks], intended for a general audience.
