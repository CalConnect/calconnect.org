...
CalConnect has published link:{{'/publications/CD1012_Intro_Calendaring.shtml' | relative_url}}[An Introduction to Internet Calendering]. This Introduction provides an overview of the major calendaring & scheduling standards and data exchange protocols. It is available in both HTML and PDF formats.
