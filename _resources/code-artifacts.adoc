...
Details: link:{{'/resources/icalendar-xml-schema' | relative_url}}[*iCalendar in XML Schema*]
...
link:{{'/resources/calws-soap-wsdl-and-schema' | relative_url}}[*CalWS-SOAP Schema*]
