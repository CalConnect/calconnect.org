...
Details: link:{{'/resources/code-artifacts/icalendar-xml-schema' | relative_url}}[*iCalendar in XML Schema*]
...
link:{{'/resources/code-artifacts/calws-soap-wsdl-and-schema' | relative_url }}[*CalWS-SOAP Schema*]
