...
Details: link:{{'/resources/interop' | relative_url}}[Getting Started at the CalConnect Interoperability Test Event]
...
Details: link:{{'/resources/conference' | relative_url}}[Getting Started at the CalConnect Conference]
...
Details: link:{{'/resources/caldav-and-carddav' | relative_url}}-and-carddav[Starter List of CalDAV and CardDAV Standards and Specifications]
