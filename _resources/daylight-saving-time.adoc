...
link:/resources/discussion-lists/time-zone-discussion[CalConnect
...
link:/news/calconnect-calls-eu-reconsider-timeline-proposed-seasonal-time-changes[*CalConnect
