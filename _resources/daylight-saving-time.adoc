...
Details: link:{{'/resources/time-zone-discussion' | relative_url}}[CalConnect Time Zone Discussion Public Mailing List]
...
Details: link:{{'/resources/extended-daylight-saving-time-review-and-considerations' | relative_url}}[Extended Daylight Saving Time Review and Considerations]
...
Details: link:{{'/resources/extended-daylight-saving-time-links-advisories-and-changes' | relative_url}}[Extended Daylight Saving Time Links, Advisories and Changes]
