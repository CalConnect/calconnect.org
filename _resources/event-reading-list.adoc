...
* link:{{'/news/2017-01-30-what-is-calendar-spam' | relative_url }}[Calendar Spam article on CalConnect]
...
* JMAP Calendars (JSCalendar): https://www.rfc-editor.org/rfc/rfc8984
* JMAP Contacts (JSContact): https://www.rfc-editor.org/rfc/rfc9553
...
* Collection Query (see https://github.com/CalConnect/PUBLIC_DRAFTS[CalConnect Public Drafts])
