...
* link:{{'/docs/architectures/Calendaring%20Architecture.pdf' | relative_url }}[Calendaring Service Architecture Diagram]
...
Become a CalConnect member: link:{{'/membership' | relative_url }}[link:{{"/membership]/" | relative_url}}[]
