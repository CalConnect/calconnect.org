...
URL: link:{{'/resources/developers-list' | relative_url}}[Calendar and Scheduling Developer List]
...
URL: link:{{'/resources/sysadmin-list' | relative_url}}[Calendaring and Scheduling Sysadmin List]
...
URL: link:{{'/resources/public-review-and-comment' | relative_url}}[Public Review and Comment List]
...
link:{{'/resources/time-zone-discussion' | relative_url}}[*Time Zone Discussion List*]
