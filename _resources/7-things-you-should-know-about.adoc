...
* link:{{'/resources/abstract-calendaring-api' | relative_url}}[7 Things You Should Know About The Abstract Calendaring API]
...
* link:{{'/resources/calendar-and-contacts-sharing' | relative_url}}[7 Things You Should Know About Calendar and Contacts Sharing]
...
* link:{{'/resources/consensus-scheduling' | relative_url}}[7 Things You Should Know About Consensus Scheduling]
...
* link:{{'/resources/push' | relative_url}}[7 Things You Should Know About PUSH]
