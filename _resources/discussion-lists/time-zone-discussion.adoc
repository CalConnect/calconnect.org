...
Mailing lists for particular technical aspects of timezones, such as the IANA Time Zone Database (https://lists.iana.org/hyperkitty/list/tz@iana.org/) or the Time Zone Data Distribution Service (https://mailman3.ietf.org/mailman3/lists/tzdist-bis@ietf.org/) do exist. Complementary to those lists however, we aim to offer a space for discussing timezone issues and best practices from a perspective that is not bound to particular systems or standards.
