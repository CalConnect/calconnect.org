...
- It will provide input to maintain the lists of outstanding CalConnect internet drafts at the IETF: link:link:{{"/resources/ietf-submissions/" | relative_url}}[IETF Submissions].
