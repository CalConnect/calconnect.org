...
information on users, devices, and more. link:{{'/about/technical-committees/closed-tcs/' | relative_url}}[TC RESOURCE]
is working on an extension of the vCard RFC to include all
required information for representing calendaring resources.

Details: link:{{'/about/technical-committees/closed-tcs/' | relative_url}}[TC RESOURCE]
