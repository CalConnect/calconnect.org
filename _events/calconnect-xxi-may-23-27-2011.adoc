---
layout: page
title: CalConnect XXI - May 23-27 2011
...
The Interoperability Test Event is open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see CalConnect Interoperability Test Event May 2011 for current information. Check back often as this will be updated as more information becomes available.
