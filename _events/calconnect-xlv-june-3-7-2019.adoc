---
layout: page
title: CalConnect XLV - June 3-7, 2019
...
_Update on CalConnect standards activities and liaisons with external SDOs. link:{{"/about/liaisons-and-relationships/" | relative_url}}[] https://datatracker.ietf.org/wg/calext/documents/_
