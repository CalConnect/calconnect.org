---
layout: page
title: CalConnect XXXV - January 11-15, 2016
...
The Interoperabilty Test Events are open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please seeNext CalConnect Interoperability Test Eventfor current information. Check back often as this will be updated as more information becomes available.
