---
layout: page
title: CalConnect XXXI - September 29-October 3, 2014
...
The Interoperability Test Events are open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see Next CalConnect Interoperability Test Event for current information. Check back often as this will be updated as more information becomes available.
