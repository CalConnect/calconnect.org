---
layout: page
title: CalConnect XXIV - May 21-25 2012
...
The IOP Test Events are open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see CalConnect Interoperability Test Event May 2012 for current information and a list of what WILL be tested at this event, plus other things that MAY be tested if there is sufficient interest. Check back often as this will be updated as more information becomes available.
...
1030-1230 Testing +
1230-1330 Lunch +
1330-1400 Shared Address Books +
1400-1430 CalDAV Test Suites +
1430-1530 Testing +
1530-1600 Break +
1600-1800 Testing
...
1700-1800 Autodiscovery moving forward
