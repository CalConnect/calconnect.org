---
layout: page
title: CalConnect XLVI - October 7-11, 2019
...
_Update on CalConnect standards activities and liaisons with external SDOs. link:{{"/about/liaisons-and-relationships/" | relative_url}}[]_
