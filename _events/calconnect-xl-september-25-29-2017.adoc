---
layout: page
title: CalConnect XL - September 25-29, 2017
...
*Test Event and Developers Forum:* Open to both members and non-members as participants or as link:{{'/events/observers' | relative_url }}[observers]; please see link:{{"/events/calconnect-xl-september-25-29-2017#test-schedule/" | relative_url}}[Test Event] for both basic information about the event and for the schedule and agenda (this will be developed gradually over the summer, so check back periodically).
...
link:{{"/sites/default/files/media/ENG%20Kulturfo%CC%88rderabgabe%20copy.pdf/" | relative_url}}[ENG KulturfoÌrderabgabe copy.pdf]
...
== Registration
Please see link:{{"/events/events-activities/interoperability-test-events/participation-and-observer-fees/" | relative_url}}[CalConnect Interoperability Test Event Registration Fees] for information about event registration fees. Please choose one of the following registration methods:

* link:{{"/events/event-registration-payment/interop-participant-registration/" | relative_url}}[CalConnect Interoperability Test Event Participant Registration]
...
* link:{{"/events/event-registration-payment/interop-observer-registration/" | relative_url}}[CalConnect Interoperability Test Event Observer Registration]
