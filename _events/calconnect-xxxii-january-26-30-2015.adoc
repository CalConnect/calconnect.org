---
layout: page
title: CalConnect XXXII - January 26-30, 2015
...
The Interoperabilty Test Events are open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see Next CalConnect Interoperability Test Event for current information. Check back often as this will be updated as more information becomes available.
