---
layout: page
title: CalConnect XIV - February 2-6 2009
...
*CalConnect Interoperability Test Event*: The IOP Test Event event is open to both members and non-members as participants or as https://web.archive.org/web/20090126053702/link:{{'/events/observers' | relative_url}}[observers]; please see https://web.archive.org/web/20090126053702/IOP Test Event February 2009 for current information. Check back often as this will be updated as we get nearer to the event. +
