---
layout: page
title: CalConnect XV - June 1-5 2009
...
*CalConnect Interoperability Test Event*: The IOP Test Event event is open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see IOP Test Event June 2009 for current information. Check back often as this will be updated as we get nearer to the event.
