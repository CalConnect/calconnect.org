---
layout: page
title: CalConnect XLI - January 29 - February 2, 2018
...
*Test Event and Developers Forum*: Open to both members and non-members as participants or as link:{{'/events/observers' | relative_url }}[observers]; please see link:{{"/events/calconnect-xli-winter-2018#test-schedule/" | relative_url}}[Test Event] for both basic information about the event and for the schedule and agenda (this will be developed gradually over the summer, so check back periodically).
