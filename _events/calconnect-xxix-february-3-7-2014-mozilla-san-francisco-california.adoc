---
layout: page
title: CalConnect XXIX - February 3-7, 2014
...
The Interoperability Test Event is open to both members and non-members as participants or as link:{{'/events/observers' | relative_url}}[observers]; please see CalConnect Interoperability Test Event February 2014 for current information. Check back often as this will be updated as more information becomes available.
