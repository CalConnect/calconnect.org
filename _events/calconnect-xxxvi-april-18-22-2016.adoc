---
layout: page
title: CalConnect XXXVI - April 18-22, 2016
...
March 21, 2016 - Full information for the link:{{"/events/calconnect-public-day-hong-kong-it-fest/" | relative_url}}[CalConnect Public Day] on wednesday April 20th has been added in its own event page.
...
*CalConnect Public Day:* The Public Day is Wednesday April 20 at the Hong Kong Convention Centre. The schedule for the day is available at link:{{"/events/calconnect-public-day-hong-kong-it-fest/" | relative_url}}[]. Please see:https://www.itfest.hk/template?series=2&id=141&lang=en# for more information about the Hong Kong ITFEST and the Public Day.
...
For information about the two optional tours on Saturday after the close of the CalConnect event please see link:{{"/misc/calconnect-xxxvi-optional-tours-saturday-23-april-2016/" | relative_url}}[link:{{"/misc/calconnect-xxxvi-optional-tours-saturday...]./" | relative_url}}[]
...
Or download this booking form, fill out and fax to the number provided on the form.
...
Please see link:{{'/events/conference-fees' | relative_url}}[CalConnect Interoperability Test Event Registration Fees] for information about event registration fees. Please choose one of the following registration methods:

for the CalConnect Interoperability Test Event.

* link:{{'/events/event-registration-payment/interop-participant-registration' | relative_url}}[CalConnect Interoperability Test Event Participant Registration]: Register one to six people as participants for the CalConnect Interoperability Test Event, with a choice of payment options.

* link:{{'/events/event-registration-payment/interop-observer-registration' | relative_url}}[CalConnect Interoperability Test Event Observer Registration]: Register one to six people as link:{{'/events/observers' | relative_url}}[observers]
